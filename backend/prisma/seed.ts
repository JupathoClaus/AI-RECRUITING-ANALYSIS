...
const PERMISSIONS = [
  ...
  {
    code: 'jobs.manage_templates',
    name: 'Manage job templates',
    resource: 'jobs',
    action: 'manage_templates',
  },
  {
    code: 'jobs.manage_pipeline',
    name: 'Manage job pipeline',
    resource: 'jobs',
    action: 'manage_pipeline',
  },
  {
    code: 'jobs.manage_screening',
    name: 'Manage job screening',
    resource: 'jobs',
    action: 'manage_screening',
  },
  {
    code: 'jobs.manage_collaborators',
    name: 'Manage job collaborators',
    resource: 'jobs',
    action: 'manage_collaborators',
  },
  {
    code: 'jobs.view_sensitive',
    name: 'View sensitive job data',
    resource: 'jobs',
  ...
  {
    code: 'candidates.manage_tags',
    name: 'Manage candidate tags',
    resource: 'candidates',
    action: 'manage_tags',
  },
  {
    code: 'candidates.manage_notes',
    name: 'Manage candidate notes',
    resource: 'candidates',
    action: 'manage_notes',
  },
  {
    code: 'candidates.manage_company_profile',
    name: 'Manage company candidate profile',
    resource: 'candidates',
    action: 'manage_company_profile',
  },
  {
  ...
  {
    code: 'applications.hire',
    name: 'Mark applications hired',
    resource: 'applications',
    action: 'hire',
  },
  {
    code: 'applications.assign',
    name: 'Assign applications',
    resource: 'applications',
    action: 'assign',
  },
  {
    code: 'applications.view_screening_answers',
    name: 'View screening answers',
    resource: 'applications',
    action: 'view_screening_answers',
  },
  {
    code: 'applications.add_notes',
    name: 'Add application notes',
    resource: 'applications',
    action: 'add_notes',
  },
  {
    code: 'applications.delete_notes',
    name: 'Delete application notes',
    resource: 'applications',
    action: 'delete_notes',
  },
  {
    code: 'applications.manage_flags',
    name: 'Manage application flags',
    resource: 'applications',
    action: 'manage_flags',
  },
  ...
  // Phase 6 — recruiter-controlled assessment engine
...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  HR_MANAGER: [
    ...
    'jobs.approve',
    'jobs.assign',
    'jobs.manage_templates',
    'jobs.manage_pipeline',
    'jobs.manage_screening',
    'jobs.manage_collaborators',
    'jobs.view_sensitive',
    'jobs.export',
    'candidates.read',
    'candidates.update',
    ...
    'candidates.manage_tags',
    'candidates.manage_notes',
    'candidates.manage_company_profile',
    'applications.read',
    'applications.create',
    'applications.update',
    'applications.move',
    ...
    'applications.hire',
    'applications.assign',
    'applications.view_screening_answers',
    'applications.add_notes',
    'applications.delete_notes',
    'applications.manage_flags',
