...
export default registerAs('tavus', () => ({
  ...
  recording: {
    ...
    projectId: process.env.TAVUS_RECORDING_PROJECT_ID || '',
    ...
    storageAccount: process.env.TAVUS_RECORDING_STORAGE_ACCOUNT || '',
    container: process.env.TAVUS_RECORDING_CONTAINER || '',
    tenantId: process.env.TAVUS_RECORDING_TENANT_ID || '',
    clientId: process.env.TAVUS_RECORDING_CLIENT_ID || '',
    keyTemplate: process.env.TAVUS_RECORDING_KEY_TEMPLATE || '',
  },
  artifactSyncIntervalMs: parseInt(process.env.TAVUS_ARTIFACT_SYNC_INTERVAL_MS || '120000', 10),
  ...
  autoEndStaleAfterMinutes: parseInt(process.env.TAVUS_AUTO_END_STALE_AFTER_MINUTES || '60', 10),
}));
